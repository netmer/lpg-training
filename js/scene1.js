...
(function(){
  ...
  const EQUIP = {
    bullet: {
      ...
      role:'STORAGE',
      desc:'ถังทรงกระบอกแนวนอน รับความดัน 17-20 บาร์ บรรจุ LPG เหลวสูงสุด 85% เผื่อ ullage 15% สำหรับการขยายตัวของก๊าซเมื่ออุณหภูมิสูง ติดตั้ง PSV ที่จุดสูงสุด',
    ...
    pump: {
      ...
      role:'TRANSFER',
      desc:'ปั๊มหอยโข่งดูดของเหลวจากถังเก็บส่งไปยังหัวบรรจุ ใช้ใบพัดหมุนสร้างความดัน 8-10 บาร์ มี mechanical seal ทนน้ำมัน LPG และ by-pass valve ป้องกัน dead-head',
      img:'./images/pump.jpg'
    },
    compressor: {
    ...
    leak: {
      ...
      role:'QUALITY',
      desc:'ตู้ปิดที่มีเซ็นเซอร์ก๊าซตรวจที่ 3 จุด: O-ring คอวาล์ว / ลิ้นวาล์ว / รอยเชื่อมตัวถัง ตรวจได้ระดับ 100 ppm ภายใน 3 วินาที',
      img:'./images/detector.jpg'
    },
    warehouse: {
      title:'โกดังเก็บถังบรรจุแล้ว',
      role:'DISPATCH',
      desc:'พื้นที่จัดเก็บถัง LPG ที่ผ่านการตรวจสอบ แยกตามขนาด/ลูกค้า มีระบบระบายอากาศ ห้ามวางใกล้แหล่งความร้อนหรือถังเปล่า',
